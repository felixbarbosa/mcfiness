...
class ExerciciosNovaVariacao extends StatefulWidget {
  ...
  @override
  _ExerciciosNovaVariacaoState createState() => _ExerciciosNovaVariacaoState(
...
class _ExerciciosNovaVariacaoState extends State<ExerciciosNovaVariacao> {
  ...
  Future<void> _novaVariacaoExercicio() async {

    print("Musculo id = $musculoIdLocal");
    print("Exercicio id = $exercicioIdLocal");
    print("Descricao = ${nome.text}");
    print("Professor id = $personalIdLocal");

    try{

      Map<String, dynamic> result = await Graphql.salvarVariacoesExercicio(
        VariacoesExercicio(
          id: 0,
          ...
          exercicio: exercicioIdLocal,
          isVariacao: 1
        )
      );

        if (result['salvarVariacaoExercicio']['id'] >= 0) {
          ...
          showDialog(
              ...
              builder: (context) => AlertDialog(
                    title: const Text('Variação não incluida'),
                    actions: [
                      TextButton(
                        ...
                        child: Card(
                          ...
                          child: Center(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                'Nova Variação $nomeExercicioLocal',
                                style: TextStyle(
                        ...
                        child: Padding(
                            ...
                            child: Center(
                                ...
                                child: IgnorePointer(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      fillColor: Colors.white,
                                      filled: true,
                                      hintText: "$musculoIdLocal - $nomeMusculoLocal",
                                      hintStyle: TextStyle(
                                        color: Colors.black,
                                      )
                                    ),
                              ...
                              MaterialButton(
                                ...
                                color: (clicouSalvar || nome.text == "" || (musculoId == 0 && musculoIdLocal == 0)) ? Colors.grey : Colors.grey[900],
                                textColor: Colors.white,
                                minWidth: double.infinity,
                                height: 42,
                                onPressed: () {
                                  if(!clicouSalvar && nome.text != "" && (musculoId != 0 || musculoIdLocal != 0)){
                                    if(urlImage.text == "" && urlVideo.text != ""){
                                      uploadingImage = false;
                                      pickAndUploadVideo(fileVideo);
                                    }else if(urlImage.text != "" && urlVideo.text == ""){
